...
- short — короткий опис
- details — повний текст або основний зміст (ДУЖЕ ВАЖЛИВО)
...
2. НАЙВАЖЛИВІШЕ щоб статтю шукав саме по ситуації ситуація 
...
8. score від 0 до 30:
   - 0-10 — максимально схожо
   - 11-15 — э співпадіння
   - 16-20 — не дуже схоже
   - 21-30 — схоже але не дуже
   9. Слова або формулювання в запиті можуть не збігатися з текстом статті, але якщо сенс і юридична суть одна — це релевантно.
  10. Якщо в запиті є помилки, розмовні формулювання або синоніми — все одно намагайся знайти правильну статтю.
